      ...
      switch (fieldName) {
        ...
        case "contactPhone":
          if (!value.trim()) {
            ...
            result = {
              isValid: false,
              message:
                "Please enter a valid PH mobile number (e.g., +63 976 125 1205)",
            };
          } else {
            result = {
              isValid: true,
        ...
        case "description":
          if (!value.trim()) {
            ...
            result = {
              isValid: false,
              message: `Please provide at least 50 characters (${value.trim().length}/50)`,
            };
          } else {
            result = {
              isValid: true,
              message: `Good description (${value.trim().length} characters)`,
            };
          }
          break;
