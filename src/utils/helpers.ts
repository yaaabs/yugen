import { FormData, FormErrors, ProjectSubmission, NotificationEvent } from '../types';
...
export const validateForm = (data: FormData): FormErrors => {
  ...
  if (!data.description.trim()) {
    ...
    errors.description = 'Please provide at least 50 characters for the project description';
  }
...
export const getStatusProgress = (status: ProjectSubmission['status']): number => {
  switch (status) {
    case 'Submitted':
      return 20;
    case 'Under Review':
