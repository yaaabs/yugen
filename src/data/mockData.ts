...
export const mockProjects: ProjectSubmission[] = [
  {
    ...
    description:
      "We need a comprehensive dashboard to track our carbon footprint, energy consumption, and waste reduction initiatives across our 15 office locations. The dashboard should provide real-time data visualization and automated reporting capabilities.",
    timeline: "3-4 months",
  ...
  },
  {
    ...
    description:
      "Complete website redesign for our environmental education non-profit. We need a modern, accessible site that showcases our programs, allows for online donations, and includes a blog section for our educational content.",
    timeline: "6-8 weeks",
  ...
  },
  {
    ...
    description:
      "Integration of multiple sustainability data sources (energy monitoring systems, waste tracking, transportation logs) into a unified reporting platform for ESG compliance.",
    timeline: "4-6 months",
    ...
    adminNotes:
      "Proposal sent. Waiting for client feedback on technical specifications.",
  ...
  },
  {
    ...
    description:
      "Custom inventory management system for organic produce tracking from farm to market, including sustainability metrics and certification tracking.",
    timeline: "2-3 months",
  ...
  },
  {
    ...
    projectType: "Website Development" as ProjectType,
    description:
      "Public-facing portal for community members to submit sustainability ideas, track city environmental initiatives, and access educational resources about urban sustainability practices.",
    timeline: "8-10 weeks",
  ...
  },
  {
    id: "proj_6",
    companyName:
      "International Sustainable Technology Solutions & Environmental Consulting Corporation Ltd.",
    contactEmail: "info@internationalsustainabletechnologysolutions.com",
    contactPhone: "+63-917-123-4567",
    projectType: "Data Integration" as ProjectType,
    description:
      "Complex enterprise-level sustainability data integration project requiring comprehensive dashboard development with real-time monitoring capabilities.",
    timeline: "4-6 months",
    ...
    adminNotes:
      "Awaiting client feedback on proposed technical architecture and timeline adjustments.",
