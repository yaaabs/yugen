...
const ClientProtectedRoute: React.FC<ClientProtectedRouteProps> = ({ children, fallbackPath = '/client/login' }) => {
  ...
  if (!isAuthenticated || !user) {
    const redirectTo = location.pathname !== '/client/login' ? location.pathname : '/client';
