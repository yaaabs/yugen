      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-[#1A66FF] hidden sm:block">Client Communication Portal</p>
            </div>
          </a>
        ...
        <div className={`lg:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
            ...
            <button
              onClick={() => { onNavigateToPortal(); closeMobileMenu(); }}
            ...
            <button
              onClick={() => { onNavigateToTracker(); closeMobileMenu(); }}
              className="flex items-center w-full px-4 py-3 rounded-md text-base font-medium text-gray-700 hover:text-[#1A66FF] hover:bg-gray-50 transition-colors duration-200"
            >
              Track Project
            </button>
            <button
              onClick={() => { onViewGitHub(); closeMobileMenu(); }}
