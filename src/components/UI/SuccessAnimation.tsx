    ...
    <div className={`fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-300 ${
      ...
      <div className={`bg-white rounded-2xl shadow-2xl p-8 max-w-md mx-4 text-center transform transition-all duration-500 ${
        ...
        <div className="relative mb-6">
          ...
          {/* Sparkle Effects */}
          <div className={`absolute inset-0 transition-opacity duration-1000 delay-300 ${
            isAnimating ? 'opacity-100' : 'opacity-0'
          }`}>
...
export const FloatingSuccess: React.FC<FloatingSuccessProps> = ({
  ...
  return (
    <div className={`fixed ${position === 'top' ? 'top-4' : 'bottom-4'} right-4 z-40 transform transition-all duration-300 ${
